...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { term: 'CPI', full: 'Consumer Price Index', def: 'The headline inflation gauge — out-of-pocket urban consumer prices; what COLA and TIPS are tied to.' },
  { term: 'PCE', full: 'Personal Consumption Expenditures price index', def: 'The inflation gauge the Fed actually targets at 2% — broader scope (incl. employer-paid healthcare) and a chained formula, so it usually runs ~0.3pp below CPI.' },
  { term: 'Core CPI / PCE', full: 'Core inflation (ex food & energy)', def: 'Inflation with the two noisiest components stripped out — the trend the Fed can actually influence.' },
  ...
  { term: 'SOFR', full: 'Secured Overnight Financing Rate', def: 'Overnight borrowing against Treasury collateral — the floating-rate benchmark; a fundamentally different rate from a bond yield.' },
  { term: 'EFFR', full: 'Effective Federal Funds Rate', def: 'What overnight interbank money actually trades at inside the Fed’s target range (≈3.63% vs the 3.50–3.75% target).' },
  { term: 'IORB', full: 'Interest On Reserve Balances', def: 'What the Fed pays banks to park money risk-free — the FLOOR that enforces the funds rate: an offer, not an order.' },
  { term: 'CMT', full: 'Constant Maturity Treasury', def: 'The Treasury-derived yield at a standardized maturity (e.g. 10Y CMT) — read off the curve, not one specific bond.' },
  { term: 'TIPS', full: 'Treasury Inflation-Protected Securities', def: 'Treasuries whose principal adjusts with inflation — their yield is the REAL rate.' },
  { term: 'Breakeven', full: 'Breakeven inflation', def: 'Nominal yield − real (TIPS) yield at the same maturity — the market-implied inflation approximation (10Y ≈ 2.32%).' },
  { term: 'Term premium', full: 'Term premium', def: 'The extra yield demanded purely for lending long — compensation for decade-scale uncertainty; the Fed does not set it.' },
  { term: 'PMMS', full: 'Freddie Mac Primary Mortgage Market Survey', def: 'The weekly benchmark 30-yr and 15-yr fixed mortgage rates (history back to 1971).' },
  { term: 'MBS / OAS', full: 'Mortgage-Backed Securities / Option-Adjusted Spread', def: 'The bonds mortgages become; OAS is their spread after pricing the homeowner’s prepayment option — NOT the simple mortgage−10Y difference.' },
  { term: 'NOI', full: 'Net Operating Income', def: 'A property’s rent minus operating costs, before debt — the numerator of the cap rate, DSCR, and debt yield.' },
  { term: 'Cap rate', full: 'Capitalization rate', def: 'NOI ÷ property value — the property market’s required yield; value = NOI ÷ cap rate, so small cap moves swing values hard.' },
  { term: 'DSCR', full: 'Debt Service Coverage Ratio', def: 'NOI ÷ annual debt service — how many times the property covers its loan payments; lenders get nervous below ~1.25×.' },
  { term: 'LTV', full: 'Loan-To-Value', def: 'Loan balance ÷ property value — the leverage on the asset.' },
  { term: 'Debt yield', full: 'Debt yield', def: 'NOI ÷ loan balance — the lender’s rate-independent crash test.' },
  { term: 'IPO', full: 'Initial Public Offering', def: 'The first sale of a company’s shares to public investors — primary shares raise new money, secondary shares cash out existing holders.' },
  { term: 'Greenshoe', full: 'Over-allotment option', def: 'Bankers’ option to sell up to ~15% more shares if demand is strong — extra primary dilution if exercised.' },
  { term: 'Pre/post-money', full: 'Pre-money / post-money valuation', def: 'Company value before vs after new primary capital: post = pre + primary; new investors own primary ÷ post.' },
  { term: 'ARR / NRR', full: 'Annual Recurring Revenue / Net Revenue Retention', def: 'SaaS’s revenue base and how much existing customers grow (NRR >100% = the base expands by itself).' },
  { term: 'Rule of 40', full: 'Rule of 40', def: 'Revenue growth % + profitability % (name the measure!) ≥ 40 — the SaaS growth/profit trade-off test.' },
  { term: 'GMROI', full: 'Gross Margin Return On Inventory', def: 'Gross margin dollars ÷ average inventory cost — retail’s money-per-shelf-dollar metric.' },
  { term: 'Runway', full: 'Cash runway', def: '(Cash + securities) ÷ monthly burn — months until a pre-revenue company must raise; sharper paired with months-to-catalyst.' },
  { term: 'CET1 / NIM', full: 'Common Equity Tier 1 / Net Interest Margin', def: 'Banking’s regulatory capital ratio and its core profitability spread — the metrics that replace Debt/EBITDA for banks.' },
  { term: 'ROC / ROIC', full: 'Return On (Invested) Capital', def: 'NOPAT ÷ invested capital — value creation needs it above WACC, judged against the industry’s observed level.' },
