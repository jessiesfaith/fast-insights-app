...
export const REPORT_COVERAGE: CoverageRow[] = [
  ...
  { tab: 19, name: 'Report builder (this tab)', sections: ['A Build the report (collapsible)', 'B History trends', 'Country / State / Industry sections', 'State × Industry and Country × Industry intersection cells', 'Geopolitics live', 'Belt & Road / corridors', 'Institutions & the two-decade arc', 'Coverage index'], inReport: 'Itself — the assembly point. Every section above names its source tab and step; the how-to-read instructions and the formula cards live in the guide pane beside the report, always visible whatever you scroll to.' },
];
