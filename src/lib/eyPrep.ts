...
export const GAP_CHECK: GapItem[] = [
  ...
  },
  {
    ...
    status: 'covered',
    where: 'Tab 11: the comps comparator computes both EVs and the implied control premium.',
  ...
  },
  {
    ...
    status: 'covered',
    where: 'Tab 11: the PPA calculator allocates the price and computes goodwill (default: the $800M deal).',
  ...
  },
  {
    ...
    status: 'covered',
    where: 'Tab 11: the impairment tester writes goodwill down when fair value falls below carrying value.',
  ...
  },
  {
    item: 'LBO modeling',
    status: 'covered',
    where: 'Tab 11: the LBO mini-model with exact returns attribution (growth / multiple / deleveraging). Still peripheral for EY.',
  ...
  },
  {
    ...
    status: 'covered',
    where: 'Tab 11: replacement cost less obsolescence less liabilities.',
  ...
  },
  {
    ...
    status: 'covered',
    where: 'Tab 11: the pro-forma EPS calculator with a stock/debt/cash financing mix; drilled on tab 9.',
