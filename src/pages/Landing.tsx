...
const TOOLS: ToolEntry[] = [
  ...
  },
  {
    ...
    tagline: 'Seven scenario-driven analyses: which capital move clears its hurdle (M&A, new product, capacity, AI, debt paydown) with a pro-forma WACC, underwrite a customer\'s financials to size a trade-credit line with a security & guarantee ladder and industry backdrop, a treasury playbook for money market, swaps, and derivatives, a market analysis tab — dial ranges, cross-effects, industry & asset trend charts, and the debt cycles — Dalio\'s economic machine (cycles, three equilibriums, two levers, live), a valuation workbench (5-yr DCF with terminal value, EV↔equity bridge, EV/EBITDA comps cross-check, WACC×growth sensitivity grid, three-statement linkage), and a formula reference tying every equation to its decision, with a full glossary. Education only; not investment or credit advice.',
